 ...
 */
public abstract class DynamicRoutingBase implements IOFMessageListener, IControllerCompletionListener {
    protected static Logger log = LoggerFactory.getLogger(DynamicRoutingBase.class);
    ...
    public static final int DYNAMIC_ROUTING_APP_ID = 3;
    static {
        AppCookie.registerApp(DYNAMIC_ROUTING_APP_ID, "dynamicrouting");
    }
    protected static final U64 DEFAULT_FORWARDING_COOKIE = AppCookie.makeCookie(DYNAMIC_ROUTING_APP_ID, 0);
